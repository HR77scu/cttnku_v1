                        ...
                        <div class="mailbox-form">
                            <form action="{{route('note.simpan')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mailbox-form-header">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" class="form-control" name="title" id="title" placeholder="Masukkan judul catatan">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg">
                                                    ...
                                                    <select name="type_note" id="type_note" class="form-control">
                                                        ...
                                                        <option value="no_script">No Script</option>
                                                        <option value="script">Script</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <textarea class="form-control" name="note_content" id="note_content" style="height: 300px;" title="Contents" placeholder="Isi Catatan Disini"></textarea>
                                    ...
                                    <button class="row col-lg-12 btn btn-sm btn-block btn-outline-white">Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>
