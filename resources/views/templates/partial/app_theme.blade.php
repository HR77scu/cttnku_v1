                    ...
                    <div class="row gx-2">
                        <div class="col-6">
                            <a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="dark"
                                ...
                                <div class="img"><img src="{{asset('templateku/seantheme.com/hud')}}/assets/img/mode/dark.jpg" class="object-fit-cover"
                        ...
                        <div class="col-6">
                            <a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="light"
                                ...
                                <div class="img"><img src="{{asset('templateku/seantheme.com/hud')}}/assets/img/mode/light.jpg" class="object-fit-cover"
                    ...
                    <div class="app-theme-cover">
                        <div class="app-theme-cover-item active">
                            <a href="javascript:;" class="app-theme-cover-link"
                                style="background-image: url({{asset('templateku/seantheme.com/hud')}}/assets/img/cover/cover-thumb-1.jpg);"
                        ...
                        <div class="app-theme-cover-item">
                            <a href="javascript:;" class="app-theme-cover-link"
                                style="background-image: url({{asset('templateku/seantheme.com/hud')}}/assets/img/cover/cover-thumb-2.jpg);"
                        ...
                        <div class="app-theme-cover-item">
                            <a href="javascript:;" class="app-theme-cover-link"
                                style="background-image: url({{asset('templateku/seantheme.com/hud')}}/assets/img/cover/cover-thumb-3.jpg);"
                        ...
                        <div class="app-theme-cover-item">
                            <a href="javascript:;" class="app-theme-cover-link"
                                style="background-image: url({{asset('templateku/seantheme.com/hud')}}/assets/img/cover/cover-thumb-4.jpg);"
                        ...
                        <div class="app-theme-cover-item">
                            <a href="javascript:;" class="app-theme-cover-link"
                                style="background-image: url({{asset('templateku/seantheme.com/hud')}}/assets/img/cover/cover-thumb-5.jpg);"
