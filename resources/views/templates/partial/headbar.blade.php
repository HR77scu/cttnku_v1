<div id="header" class="app-header">
			...
			<div class="brand">
				<a href="{{route('/')}}" class="brand-logo">
					...
					<span class="brand-text">HR77SCU Sec</span>
				</a>
			</div>
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
						<div class="menu-img online">
							<img src="{{asset('templateku/seantheme.com/hud')}}/assets/img/user/profile.jpg" alt="Profile" height="60">
						</div>
						<div class="menu-text d-sm-block d-none w-170px"><span class="__cf_email__" data-cfemail="186d6b7d6a7679757d58797b7b776d766c367b7775">[email&#160;protected]</span></div>
					</a>
